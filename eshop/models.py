...
class Shop(models.Model):
    ...
    def add_offer_for_user_from_city(self, offer, pickup_in_city):
        self.offers.add(offer)

    def add_pickup_for_user_from_city(self, pickup_point, pickup_in_city):
...
class CatalogShops(models.Model):
    ...
    def add_shop_for_user_from_city(self, shop, user_from_city):
        self.shops.add(shop)
