...
class TestESellerS(TestCase):
    ...
    def test_1(self):
        ...
        self.assertEqual(1000, response.context['order_sum'])
        self.assertEqual(Shop.objects.get(id=2), response.context['client'])
        self.assertEqual(700, response.context['all_ball'])
        ...
        self.assertEqual(360, response.context['max_ball_for_pay'])
        self.assertEqual(40, response.context['max_percent_in_loyalty'])
        self.assertEqual(19640, response.context['order_sum_with_ball'])
        self.assertEqual(list(Product.objects.filter(id__in=[2,3,4,5,6])), response.context['special_products'])
        #self.assertEqual(list(Product.objects.filter(id__in=[3,5])), response.context['selected_products'])
        self.assertEqual([], response.context['selected_products'])
        ...
        self.assertEqual(20000, response.context['order_sum'])
        self.assertEqual(Shop.objects.get(id=2), response.context['client'])
        self.assertEqual(1964, response.context['all_ball'])
        self.assertEqual(1964, response.context['max_ball_for_pay'])
        self.assertEqual(40, response.context['max_percent_in_loyalty'])
        ...
        self.assertEqual(1000, response.context['order_sum'])
        self.assertEqual(Shop.objects.get(id=2), response.context['client'])
        self.assertEqual(1624, response.context['all_ball'])
        self.assertEqual(400, response.context['max_ball_for_pay'])
        self.assertEqual(40, response.context['max_percent_in_loyalty'])
        self.assertEqual(600, response.context['order_sum_with_ball'])
        self.assertEqual(list(Product.objects.filter(id__in=[2,3,4,5,6])), response.context['special_products'])
        ...
        self.assertEqual(1000, response.context['order_sum'])
        self.assertEqual(Shop.objects.get(id=2), response.context['client'])
        self.assertEqual(2224, response.context['all_ball'])
        self.assertEqual(400, response.context['max_ball_for_pay'])
        self.assertEqual(40, response.context['max_percent_in_loyalty'])
        self.assertEqual(600, response.context['order_sum_with_ball'])
        self.assertEqual(list(Product.objects.filter(id__in=[2,3,4,5,6])), response.context['special_products'])
        ...
        self.assertEqual(1000, response.context['order_sum'])
        self.assertEqual(Shop.objects.get(id=2), response.context['client'])
        self.assertEqual(1884, response.context['all_ball'])
        self.assertEqual(400, response.context['max_ball_for_pay'])
        self.assertEqual(40, response.context['max_percent_in_loyalty'])
        self.assertEqual(600, response.context['order_sum_with_ball'])
        self.assertEqual(list(Product.objects.filter(id__in=[2,3,4,5,6])), response.context['special_products'])
        ...
        self.assertEqual(Shop.objects.get(id=2), response.context['client'])
        self.assertEqual(1884, response.context['all_ball'])
        self.assertEqual(1884, response.context['max_ball_for_pay'])
        self.assertEqual(40, response.context['max_percent_in_loyalty'])
        self.assertEqual(18116, response.context['order_sum_with_ball'])
        self.assertEqual(list(Product.objects.filter(id__in=[2,3,4,5,6])), response.context['special_products'])
        #self.assertEqual(list(Product.objects.filter(id__in=[3,5])), response.context['selected_products'])
        self.assertEqual([], response.context['selected_products'])
        ...
        self.assertEqual(20000, response.context['order_sum'])
        self.assertEqual(Shop.objects.get(id=2), response.context['client'])
        self.assertEqual(1811, response.context['all_ball'])
        self.assertEqual(1811, response.context['max_ball_for_pay'])
        self.assertEqual(40, response.context['max_percent_in_loyalty'])
        self.assertEqual(18189, response.context['order_sum_with_ball'])
        self.assertEqual(list(Product.objects.filter(id__in=[2,3,4,5,6])), response.context['special_products'])
        self.assertEqual([], response.context['selected_products'])
